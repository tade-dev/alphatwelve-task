                  ...
                  return SizedBox(
                    child: ListView(
                      ...
                      children: [
                        ...
                        .animate()
                        .slideX(begin: -0.3, duration: 500.ms, delay: 200.ms, curve: Curves.easeOut)
                        ...
                        .animate()
                        .scale(begin: const Offset(0.5, 0.5), duration: 600.ms, delay: 300.ms, curve: Curves.elasticOut)
                        ...
                        .animate()
                        .slideY(begin: 0.5, duration: 400.ms, delay: 500.ms, curve: Curves.easeOut)
                            ...
                            (index) => Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  .animate()
                                  .scale(begin: const Offset(0, 0), duration: 300.ms, delay: (600 + (index * 100)).ms)
                                  .fadeIn(duration: 300.ms, delay: (600 + (index * 100)).ms),
                                ),
                                Expanded(
                                  child: Text(
                                    state.selectedProduct?.description[index] ?? "",
                                    style: getRegularStyle(
                                      fontSize: 14,
                                      color: ColorManager.gray4
                                    ),
                                  ...
                                  .animate()
                                  .slideX(begin: 0.3, duration: 400.ms, delay: (650 + (index * 100)).ms, curve: Curves.easeOut)
                                  .fadeIn(duration: 400.ms, delay: (650 + (index * 100)).ms),
                                ),
                              ],
                            )
                            .animate()
                            .slideY(begin: 0.2, duration: 300.ms, delay: (600 + (index * 100)).ms, curve: Curves.easeOut)
                            .animate(onComplete: (controller) {
                              controller.repeat(reverse: true);
                            })
                            .shimmer(duration: 2000.ms, delay: (1000 + (index * 100)).ms, color: Colors.white.withOpacity(0.1))
                          ),
                        ),
                      ],
                    ),
