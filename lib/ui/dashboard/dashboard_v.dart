          ...
          builder: (context, cState) {
            return Scaffold(
              ...
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: List.generate(state.views.length, (index) {
                  switch (index) {
                    case 0:
                    ...
                    case 1:
                      return BottomNavigationBarItem(
                        icon: Badge(
                          isLabelVisible: cState.cartItems.isNotEmpty,
                          backgroundColor: Color(0xff3C4856),
                          label: Text(
                            cState.cartItems.length.toString(),
                            style: getBoldStyle(
                              color: Colors.white,
                              fontSize: 10,
                            ),
