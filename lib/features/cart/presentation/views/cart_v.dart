        ...
        builder: (context, state) {
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  BuildBtn(onPressed: () {}, label: "Checkout (\$${state.totalPrice.toStringAsFixed(2)})", textColor: ColorManager.white, color: ColorManager.primary, disabled: false),
                ],
              ),
            ),
          );
                                  ...
                                  children: List.generate(
                                    ...
                                    (index) => Padding(
                                      ...
                                      child: CartTile(
                                            ...
                                            image: state.cartItems[index].image,
    ...
    return Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                title,
                style: getMediumStyle(fontSize: 12, color: ColorManager.text),
              ),
              Text(
                desc,
                style:
                    lastwid
                        ? getBoldStyle(fontSize: 14, color: ColorManager.text)
                        : getMediumStyle(
                          fontSize: 12,
                          color: ColorManager.text,
                        ),
        ...
        .slideX(begin: -0.8, duration: 500.ms, curve: Curves.easeOutCubic)
